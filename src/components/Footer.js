...
const Footer = () => (
  <footer className="site-footer">
    <div className="footer-grid journal-container">
      ...
      <div><h3>Contact</h3><a href="mailto:editor@ijepa.org">editor@ijepa.org</a><span>+91 8149844901</span><span>Shop No 2, Snehankit Colony,<br />Karve Nagar, Pune, India</span><div className="footer-social">in &nbsp; 𝕏 &nbsp; f &nbsp; ▶</div></div>
    </div>
